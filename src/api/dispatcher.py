...
async def send_message(payload: MessageSchema):
    ...
    prompt: str = (
        ...
        f'Never give a price that is greater than that one that partner offered or you offered in a previous message,'
        f'you have previous messages in {partner_messages}'
